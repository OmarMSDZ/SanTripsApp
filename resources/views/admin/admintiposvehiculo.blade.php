...
<!-- Contenido de admin tipos vehiculos -->
<h2>Admin Tipo Vehículo<span class="text-gray float-end">SanTrips</span></h2>
<hr>
...
<div class="row d-flex">
    ...
    <div class="col-md-6">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tipovehiculo" class="form-control" placeholder="Nombre tipo de vehículo">
        </div>
            <div class="mb-3">
