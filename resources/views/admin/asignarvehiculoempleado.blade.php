...
@section('title', 'Administrador de Vehiculos Empleados')
...
<h2>Admin asignar vehiculo empleado <span class="text-gray float-end">SanTrips</span></h2>
<hr> --}}


<div class="pagetitle">
    <h1>Administración de Vehiculo Empleado</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('admin.index')}}">Home</a></li>
        <li class="breadcrumb-item active">Administración de Vehiculo Empleado</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
          ...
          <div class="card-body">
            ...
            <div class="row d-flex">
                ...
                <div class="col-12 table-container">
                    <table id="tablaasignacion_vehiculo" class="table table-hover">
                        <!-- Contenido de la tabla -->
                        <thead class="">
                        <tr>
                            {{-- <th>Id</th> --}}
                            <<th>ID Vehículo Empleado</th> 
...
<form id="formcambiarEstadoVehiculoEmpleado" action="" method="POST" class="form">
    <input name="codigo" value="0" type="hidden">
    <input name="estado" value="0" type="hidden">
    @csrf
</form>

<div class="modal fade" id="modalRegistroVehiculoEmpleado" tabindex="-1">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Registro De Vehiculo Empleado</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form id="registroVehiculoEmpleado" class="row" action="" method="POST" class="form">
                @csrf

                <input type="hidden" id="codigo_vehiculoEmpleado" name="codigo" value="0">

                <div class="col-4">
    <div class="mb-3">
        <label for="FechaAsignacion" class="form-label">Fecha Asignación</label>
        <input type="date" name="FechaAsignacion" class="form-control limpiarForm" value="{{ date('Y-m-d') }}" required>
    </div>
</div>
...
<div class="col-6 col-sm-12 col-lg-6">
    <div class="mb-3">
        ...
        <select name="id_empleado" id="id_empleado" class="form-select limpiarForm" required>
            <option value="">===</option>
            @foreach ($id_empleado as $key)
                <option value="{{ $key->IdTipoVehiculo}}">{{ $key->Nombres }}</option>
            @endforeach
        </select>
    </div>
</div>
        ...
        <select name="estado" id="estado" class="form-select limpiarForm" required>
            ...
            <option value="INACTIVO">Inactivo</option>
                ...
                {{-- <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-primary mt-1" style="width: 14em;"> <a href="" style="text-decoration: none; color: white;"> Asignar Vehiculo Empleado</a></button>
                </div> --}}
...
<script src=" {{ asset('assets/js/asignar_vehiculoempleados/asignar_vehiculoempleados.js') }}"></script>
