...
<!-- Contenido de signar vehiculo paquete -->
<h2>Asignar Vehículo a Paquete<span class="text-gray float-end">SanTrips</span></h2>
<hr>
...
<div class="row d-flex">
    ...
    <div class="col-md-6">
        ...
        <div class="mb-3">
            <label for="vehiculo" class="form-label">Vehículo de transporte asignado</label>
