...
class InicioController extends Controller
{
    ...
    public function index (){
        ...
        paquetes_turisticos as p INNER JOIN tipos as c ON p.id_categoria_paquete=c.id INNER JOIN ofertas as o ON p.fk_IdOferta=o.IdOferta where c.tipo='paquetes' and p.Disponibilidad='DISPONIBLE'
