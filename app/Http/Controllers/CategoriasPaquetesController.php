...
class CategoriasPaquetesController extends Controller
{
    ...
    {
        return view('admin.admincategoriapaquetes2');
    }
     ...
     */
     ...
     public function store(Request $request) {
        ...
        try {
            ...
            $categoriapaquete = new Categorias_paquetes();
            $categoriapaquete->Categoriapaq = $request->cedula;
             
            // $empleado->creado_por = $usuario_id;
            $categoriapaquete->save();
     ...
     */
    public function edit(Categorias_paquetes $empleados)
    {
        //
    }
     ...
     */
     ...
     public function update($id_empleado, Request $request) {
        ...
        try {
            ...
            $empleado = Categorias_paquetes::whereRaw('IdEmpleado  = ? ', [$id_empleado])->first();
    ...
    public function getEmpleado($id_empleado, Request $request) {
        ...
        $data = Categorias_paquetes::select(
                                'IdEmpleado AS id',
                                'Cedula AS cedula',
                                'Nombres AS nombre',
